    ...
    <center>
      ...
      <p id="question_added"></p>
        <table id="new_question_table">
          ...
          <tr><td><font color="red">*</font>Citation</td><td><input size="60" type="text" id="question_citation" value="" maxlength="500"></td></tr>
          ...
          <tr><td>Wrong Answer</td><td><input size="60" type="text" id="wrong_answer2" value="" maxlength="150"></td></tr>
          <tr><td>Wrong Answer</td><td><input size="60" type="text" id="wrong_answer3" value="" maxlength="150"></td></tr>
        </table>
